...
export default function Topbar({ recipientCount, totalRecipientCount, selectedCount, hasRecipients, onOpenAll, onConfig, onCheckErrors, configConnected, gmailConnected, gmailEmail }) {
    ...
    <>
      <header className="topbar">
        ...
        <div className="topbar-actions">
          ...
          <button className="btn btn-ghost btn-sm" onClick={onCheckErrors} title="Scan inbox for bounced emails and left-company replies" style={{ fontSize: 12 }}>
